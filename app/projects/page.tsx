        ...
        <div className="max-w-7xl mx-auto">
          ...
          {projectsByCategory.Nextjs && projectsByCategory.Nextjs.length > 0 && (
            <div className="mb-20">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8">Modern, performant web applications</p>
          ...
          {projectsByCategory.WordPress && projectsByCategory.WordPress.length > 0 && (
            <div className="mb-20">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8">Content-driven websites and online presence</p>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {projectsByCategory.Laravel && projectsByCategory.Laravel.length > 0 && (
            <div className="mb-20">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8">Robust backend systems and web applications</p>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
